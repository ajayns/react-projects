    ...
    return (
      <div className='mapdiv'>
        ...
        <svg width='950px' height='620px' viewBox='0 0 950 620'>
          ...
          <Link xlinkTitle='Kalimantan' onClick={(e) => this.customAlert('Kalimantan', e)}>
            <path
              id='Kalimantan'
          ...
          <Link xlinkTitle='Papua new guinea' onClick={(e) => this.customAlert('Papua New Guinea', e)}>
            <path
              id='Papua new guinea'
          ...
          <Link xlinkTitle='mexico' onClick={(e) => this.customAlert('Mexico', e)}>
            <path
              id='mexico'
          ...
          <Link xlinkTitle='Estonia' onClick={(e) => this.customAlert('Estonia', e)}>
            <path
              id='Estonia'
              d='M517.77,143.66l-5.6-0.2l-3.55,2.17l-0.05,1.61l2.3,2.17l7.15,1.21L517.77,143.66L517.77,143.66z'
            />
          </Link>
          <Link xlinkTitle='Algeria' onClick={(e) => this.customAlert('Algeria', e)}>
            <path
              id='Algeria'
          ...
          <Link xlinkTitle='Morocco' onClick={(e) => this.customAlert('Morocco', e)}>
            <path
              id='morocco'
          ...
          <Link xlinkTitle='mauretania' onClick={(e) => this.customAlert('Mauretania', e)}>
            <path
              id='mauretania'
          ...
          <Link xlinkTitle='senegal' onClick={(e) => this.customAlert('Senegal', e)}>
            <path
              id='senegal'
          ...
          <Link xlinkTitle='sierra leone' onClick={(e) => this.customAlert('Sierra Leone', e)}>
            <path
              id='sierra leone'
              d='M413.93,313.13l5.65,5.46l4.03-4.89l-2.52-3.95l-3.47,0.35L413.93,313.13L413.93,313.13z'
            />
          </Link>
          <Link xlinkTitle='liberia' onClick={(e) => this.customAlert('Liberia', e)}>
            <path
              id='liberia'
              d='M420.17,319.19l10.98,7.34l-0.26-5.56l-3.32-3.91l-3.24-2.87L420.17,319.19L420.17,319.19z'
            />
          </Link>
          <Link xlinkTitle='ivoire' onClick={(e) => this.customAlert('Ivoire', e)}>
            <path
              id='ivoire'
          ...
          <Link xlinkTitle='mali' onClick={(e) => this.customAlert('Mali', e)}>
            <path
              id='mali'
          ...
          <Link xlinkTitle='burkina' onClick={(e) => this.customAlert('Burkina', e)}>
            <path
              id='burkina'
          ...
          <Link xlinkTitle='niger' onClick={(e) => this.customAlert('Niger', e)}>
            <path
              id='niger'
          ...
          <Link xlinkTitle='tunisia' onClick={(e) => this.customAlert('Tunisia', e)}>
            <path
              id='tunisia'
          ...
          <Link xlinkTitle='libya' onClick={(e) => this.customAlert('Libya', e)}>
            <path
              id='libya'
          ...
          <Link xlinkTitle='Egypt' onClick={(e) => this.customAlert('Egypt', e)}>
            <path
              id='Egypt'
          ...
          <Link xlinkTitle='chad' onClick={(e) => this.customAlert('Chad', e)}>
            <path
              id='chad'
          ...
          <Link xlinkTitle='south sudan' onClick={(e) => this.customAlert('South Sudan', e)}>
            <path
          ...
          <Link xlinkTitle='sudan' onClick={(e) => this.customAlert('Sudan', e)}>
            <path
          ...
          <Link xlinkTitle='cameroon' onClick={(e) => this.customAlert('Cameroon', e)}>
            <path
              id='cameroon'
          ...
          <Link xlinkTitle='somaliland' onClick={(e) => this.customAlert('Somaliland', e)}>
            <path
              id='somaliland'
          ...
          <Link xlinkTitle='soqotra' onClick={(e) => this.customAlert('Soqotra', e)}>
            <path
              id='soqotra'
              d='M599.62,299.65l2.13,2.38l2.88-1.74l1.04-0.35l-1.32-1.28l-2.53,0.75L599.62,299.65L599.62,299.65z'
            />
          </Link>
          <Link xlinkTitle='somalia' onClick={(e) => this.customAlert('Somalia', e)}>
            <path
              id='somalia'
          ...
          <Link xlinkTitle='centrafrique' onClick={(e) => this.customAlert('Centrafrique', e)}>
            <path
              id='centrafrique'
          ...
          <Link xlinkTitle='Equatorial guinea' onClick={(e) => this.customAlert('Equatorial Guinea', e)}>
            <path
              id='Equatorial guinea'
              d='M480.99,332.69l-0.06,1.39l4.54,0.23l-0.06-1.57L480.99,332.69L480.99,332.69z'
            />
          </Link>
          <Link xlinkTitle='congo' onClick={(e) => this.customAlert('Congo', e)}>
            <path
              id='congo'
          ...
          <Link xlinkTitle='cabinda' onClick={(e) => this.customAlert('Cabinda', e)}>
            <path
              id='cabinda'
              d='M486.55,353.23l1.74,2.26l2.25-2.13l-0.66-2.21l-0.56-0.04L486.55,353.23L486.55,353.23z'
            />
          </Link>
          <Link xlinkTitle='drc' onClick={(e) => this.customAlert('Drc', e)}>
            <path
              id='drc'
          ...
          <Link xlinkTitle='rwanda' onClick={(e) => this.customAlert('Rwanda', e)}>
            <path
              id='rwanda'
              d='M537.82,339.9l2.81,2.59l-0.12,2.77l-4.36,0.09v-3.06L537.82,339.9L537.82,339.9z'
            />
          </Link>
          <Link xlinkTitle='burundi' onClick={(e) => this.customAlert('Burundi', e)}>
            <path
              id='burundi'
              d='M536.21,346.21l4.27-0.09l-1.11,3.74l-1.08,0.94h-1.32l-0.94-2.53L536.21,346.21L536.21,346.21z'
            />
          </Link>
          <Link xlinkTitle='uganda' onClick={(e) => this.customAlert('Uganda', e)}>
            <path
              id='uganda'
          ...
          <Link xlinkTitle='Kenya' onClick={(e) => this.customAlert('Kenya', e)}>
            <path
              id='Kenya'
          ...
          <Link xlinkTitle='tanzania' onClick={(e) => this.customAlert('Tanzania', e)}>
            <path
              id='tanzania'
          ...
          <Link xlinkTitle='zambia' onClick={(e) => this.customAlert('Zambia', e)}>
            <path
              id='zambia'
          ...
          <Link xlinkTitle='Angola' onClick={(e) => this.customAlert('Angola', e)}>
            <path
              id='Angola'
          ...
          <Link xlinkTitle='malawi' onClick={(e) => this.customAlert('Malawi', e)}>
            <path
              id='malawi'
          ...
          <Link xlinkTitle='mozambique' onClick={(e) => this.customAlert('Mozambique', e)}>
            <path
              id='mozambique'
          ...
          <Link xlinkTitle='zimbabwe' onClick={(e) => this.customAlert('Zimbabwe', e)}>
            <path
              id='zimbabwe'
          ...
          <Link xlinkTitle='namibia' onClick={(e) => this.customAlert('Namibia', e)}>
            <path
              id='namibia'
          ...
          <Link xlinkTitle='botswana' onClick={(e) => this.customAlert('Botswana', e)}>
            <path
              id='botswana'
          ...
          <Link xlinkTitle='swaziland' onClick={(e) => this.customAlert('Swaziland', e)}>
            <path
              id='swaziland'
              d='M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z'
            />
          </Link>
          <Link xlinkTitle='lesotho' onClick={(e) => this.customAlert('Lesotho', e)}>
            <path
              id='lesotho'
          ...
          <Link xlinkTitle='south africa' onClick={(e) => this.customAlert('South Africa', e)}>
            <path
              id='south africa'
              d='M534.16,403.63l-7.9,7.3l-1.88,4.51l-6.26-0.78l-5.21,4.63l-3.46-0.34l0.28-6.4l-1.23-0.43l-0.86,13.09l-6.14-0.06l-1.85-2.18l-2.71-0.03l2.47,7.09l4.41,4.17l-3.15,3.67l2.04,4.6l4.72,1.8l3.76-3.2l10.77,0.06l0.77-0.96l4.78-0.84l16.17-16.1l-0.06-5.07l-1.73,2.24h-2.59l-3.15-2.64l1.6-3.98l2.75-0.56l-0.25-8.18L534.16,403.63L534.16,403.63z M530.37,422.13l1.51-0.06l2.45,2.66l-0.07,3.08l-2.87,1.45l-0.18,1.02l-4.38,0.05l-1.37-3.3l1.25-2.42L530.37,422.13L530.37,422.13z'
            />
          </Link>
          <Link xlinkTitle='greenland' onClick={(e) => this.customAlert('Greenland', e)}>
            <path
              id='greenland'
          ...
          <Link xlinkTitle='disko' onClick={(e) => this.customAlert('Disko', e)}>
            <path
              id='disko'
              d='M342.89,92.49l1.63,2.45l-0.82,2.99h-1.63l-2.18-2.45l0.54-1.9L342.89,92.49L342.89,92.49z'
            />
          </Link>
          <Link xlinkTitle='milne' onClick={(e) => this.customAlert('Milne', e)}>
            <path
              id='milne'
              d='M410.87,85.69l4.62,1.36l-0.27,3.81l-4.89-2.45l-1.09-1.36L410.87,85.69L410.87,85.69z'
            />
          </Link>
          <Link xlinkTitle='East antarctica' onClick={(e) => this.customAlert('East Antarctica', e)}>
            <path
              id='East antarctica'
          ...
          <Link xlinkTitle='Antarctic peninsula' onClick={(e) => this.customAlert('Antarctic Peninsula', e)}>
            <path
          ...
          <Link xlinkTitle='thurston' onClick={(e) => this.customAlert('Thurston', e)}>
            <path
              id='thurston'
          ...
          <Link xlinkTitle='Alexander' onClick={(e) => this.customAlert('Alexander', e)}>
            <path
              id='Alexander'
          ...
          <Link xlinkTitle='tasmania' onClick={(e) => this.customAlert('Tasmania', e)}>
            <path
              id='tasmania'
              d='M825.74,496.26l-1.77,7.15l0.35,5l5.32-0.36l6.03-9.29L825.74,496.26L825.74,496.26z'
            />
          </Link>
          <Link xlinkTitle='new zealand north island' onClick={(e) => this.customAlert('New Zealand', e)}>
            <path
          ...
          <Link xlinkTitle='new zealand south island' onClick={(e) => this.customAlert('New Zealand', e)}>
            <path
          ...
          <Link xlinkTitle='new caledonia' onClick={(e) => this.customAlert('New Caledonia', e)}>
            <path
              id='new caledonia'
              d='M906.64,420.47l-0.35,1.79l4.61,6.43l2.48,1.07l0.35-2.5L906.64,420.47L906.64,420.47z'
            />
          </Link>
          <Link xlinkTitle='sumatra' onClick={(e) => this.customAlert('Sumatra', e)}>
            <path
              id='sumatra'
          ...
          <Link xlinkTitle='East malaysia' onClick={(e) => this.customAlert('East Malaysia', e)}>
            <path
              id='East malaysia'
          ...
          <Link xlinkTitle='brunei' onClick={(e) => this.customAlert('Brunei', e)}>
            <path
              id='brunei'
              d='M779.77,319.25l-2.88,3.49l2.36,0.74l1.33-1.86L779.77,319.25L779.77,319.25z'
            />
          </Link>
          <Link xlinkTitle='sulawesi' onClick={(e) => this.customAlert('Sulawesi', e)}>
            <path
              id='sulawesi'
          ...
          <Link xlinkTitle='maluku' onClick={(e) => this.customAlert('Maluku', e)}>
            <path
              id='maluku'
              d='M814.19,330.5l-1.87,4.55l2.95,3.86h0.98l1.28-2.57l0.69-0.89l-1.28-1.39l-1.87-0.69L814.19,330.5L814.19,330.5z'
            />
          </Link>
          <Link xlinkTitle='seram' onClick={(e) => this.customAlert('Seram', e)}>
            <path
              id='seram'
          ...
          <Link xlinkTitle='java' onClick={(e) => this.customAlert('Java', e)}>
            <path
              id='java'
          ...
          <Link xlinkTitle='luzon' onClick={(e) => this.customAlert('Luzon', e)}>
            <path
              id='luzon'
          ...
          <Link xlinkTitle='shikoku' onClick={(e) => this.customAlert('Shikoku', e)}>
            <path
              id='shikoku'
              d='M812.03,213.15l-2.77,2.6l-0.1,2.99l0.67,0.87l3.73-3.18l-0.29-3.18L812.03,213.15L812.03,213.15z'
            />
          </Link>
          <Link xlinkTitle='honshu' onClick={(e) => this.customAlert('Honshu', e)}>
            <path
              id='honshu'
          ...
          <Link xlinkTitle='hokkaido' onClick={(e) => this.customAlert('Hokkaido', e)}>
            <path
              id='hokkaido'
          ...
          <Link xlinkTitle='St. lawrence island west' onClick={(e) => this.customAlert('St. Lawrence Island West', e)}>
            <path
              id='st. lawrence island west'
              d='M69.17,53.35l3.46,6.47l2.22-0.5v-2.24L69.17,53.35L69.17,53.35z'
            />
          </Link>
          <Link xlinkTitle='Alaska' onClick={(e) => this.customAlert('Alaska', e)}>
            <path
              id='Alaska'
          ...
          <Link xlinkTitle='chukotka' onClick={(e) => this.customAlert('Chukotka', e)}>
            <path
              id='chukotka'
          ...
          <Link xlinkTitle='domincan republic' onClick={(e) => this.customAlert('Domincan Republic', e)}>
            <path
          ...
          <Link xlinkTitle='haiti' onClick={(e) => this.customAlert('Haiti', e)}>
            <path
              id='haiti'
          ...
          <Link xlinkTitle='falklands west' onClick={(e) => this.customAlert('Falklands West', e)}>
            <path
              id='falklands west'
              d='M307.95,508.18l-2.63-0.29l-2.62,1.76l1.9,2.06L307.95,508.18L307.95,508.18z'
            />
          </Link>
          <Link xlinkTitle='falklands east' onClick={(e) => this.customAlert('Falklands East', e)}>
            <path
              id='falklands east'
              d='M310.57,506.86l-0.87,2.79l-2.48,2.2l0.15,0.73l4.23-1.62l1.75-2.2L310.57,506.86L310.57,506.86z'
            />
          </Link>
          <Link xlinkTitle='iceland' onClick={(e) => this.customAlert('Iceland', e)}>
            <path
              id='iceland'
          ...
          <Link xlinkTitle='spitsbergen' onClick={(e) => this.customAlert('Spitsbergen', e)}>
            <path
              id='spitsbergen'
          ...
          <Link xlinkTitle='nordaustlandet' onClick={(e) => this.customAlert('Nordaustlandet', e)}>
            <path
              id='nordaustlandet'
          ...
          <Link xlinkTitle='novaya zemlya south' onClick={(e) => this.customAlert('Novaya Zemlya South', e)}>
            <path
          ...
          <Link xlinkTitle='Komsomolets' onClick={(e) => this.customAlert('Komsomolets', e)}>
            <path
              id='Komsomolets'
              d='M634.95,18.15l-2.24-1.39h-2.58l-0.52,1.56l-2.75,1.56l-2.07,0.69l-0.34,2.08l4.82,0.35L634.95,18.15L634.95,18.15z'
            />
          </Link>
          <Link xlinkTitle='october' onClick={(e) => this.customAlert('October', e)}>
            <path
              id='october'
          ...
          <Link xlinkTitle='bolshevik' onClick={(e) => this.customAlert('Bolshevik', e)}>
            <path
              id='bolshevik'
              d='M645.28,20.58l1.21,4.86l1.89,4.51l2.07-3.64l3.96-0.87v-2.6l-2.58-1.91L645.28,20.58L645.28,20.58z'
            />
          </Link>
          <Link xlinkTitle='Kotelny' onClick={(e) => this.customAlert('Kotelny', e)}>
            <path
              id='Kotelny'
          ...
          <Link xlinkTitle='cuba' onClick={(e) => this.customAlert('Cuba', e)}>
            <path
              id='cuba'
          ...
          <Link xlinkTitle='irian jaya' onClick={(e) => this.customAlert('Irian Jaya', e)}>
            <path
              id='irian jaya'
          ...
          <Link xlinkTitle='Alaska-westcopy' onClick={(e) => this.customAlert('Alaska-Westcopy', e)}>
            <path
              id='Alaska-westcopy'
              d='M93.11,44.89l-8.39,1.99l1.73,9.45l9.13,2.49l0.49,1.99L82.5,65.04l-7.65,12.68l2.71,13.43L82,94.13l3.46-3.23l0.99,1.99l-4.2,4.97l-16.29,7.46l-10.37,2.49l-0.25,3.73l23.94-6.96l9.87-2.74l9.13-11.19l10.12-6.71l-5.18,8.7l5.68,0.75l9.63-4.23l1.73,6.96l6.66,1.49l6.91,6.71l0.49,4.97l-0.99,1.24l1.23,4.72h1.73l0.25-7.96h1.97l0.49,19.64l4.94-4.23l-3.46-20.39h-5.18l-5.68-7.21l27.89-47.25l-27.64-21.63l-30.85,5.97l-1.23,9.45l6.66,3.98l-2.47,6.47L93.11,44.89L93.11,44.89z'
            />
          </Link>
          <Link xlinkTitle='galapagos' onClick={(e) => this.customAlert('Galapagos', e)}>
            <path
              id='galapagos'
              d='M194.97,338.18l-0.62,2.75l-1.15,1.16l0.79,1.42l2.03-0.8l0.97-1.69l-0.62-1.78L194.97,338.18L194.97,338.18z'
            />
          </Link>
          <Link xlinkTitle='banks' onClick={(e) => this.customAlert('Banks', e)}>
            <path
              id='banks'
          ...
          <Link xlinkTitle='Prince patrick' onClick={(e) => this.customAlert('Prince Patrick', e)}>
            <path
              id='Prince patrick'
          ...
          <Link xlinkTitle='Eglinton' onClick={(e) => this.customAlert('Eglinton', e)}>
            <path
              id='Eglinton'
          ...
          <Link xlinkTitle='victoria' onClick={(e) => this.customAlert('Victoria', e)}>
            <path
              id='victoria'
          ...
          <Link xlinkTitle='Prince of wales' onClick={(e) => this.customAlert('Prince of Wales', e)}>
            <path
              id='Prince of wales'
          ...
          <Link xlinkTitle='baffin' onClick={(e) => this.customAlert('Baffin', e)}>
            <path
              id='baffin'
              d='M282.88,61.59L278,61.14l-5.76,2.23l-3.1,4.24l0.89,11.62l9.53,0.45l9.09,4.47l6.43,7.37l4.88-0.22l-1.33,6.92l-4.43,7.37l-4.88,2.23l-3.55-0.67l-1.77-1.56l-2.66,3.57l1.11,3.57l3.77,0.22l4.66-2.23l3.99,10.28l9.98,6.48l6.87-8.71l-5.76-9.38l3.33-3.8l4.66,7.82l8.42-7.37l-1.55-3.35l-5.76,1.79l-3.99-10.95l3.77-6.25l-7.54-8.04l-4.21,2.9l-3.99-8.71l-8.42,1.12l-2.22-10.5l-6.87,4.69l-0.67,5.81h-3.77l0.44-5.14L282.88,61.59L282.88,61.59z'
            />
          </Link>
          <Link xlinkTitle='bylot' onClick={(e) => this.customAlert('Bylot', e)}>
            <path
              id='bylot'
              d='M292.86,65.61l-1.77,1.79l1.55,2.46l7.32,0.89l-4.66-4.92L292.86,65.61L292.86,65.61z'
            />
          </Link>
          <Link xlinkTitle='Ellesmere' onClick={(e) => this.customAlert('Ellesmere', e)}>
            <path
              id='Ellesmere'
          ...
          <Link xlinkTitle='southhampton' onClick={(e) => this.customAlert('Southhampton', e)}>
            <path
              id='southhampton'
              d='M266.01,101.85l-4.23,5.32l-0.26,5.86l3.7-2.13h4.49l3.17,2.93l2.91-2.4L266.01,101.85L266.01,101.85z'
            />
          </Link>
          <Link xlinkTitle='newfoundland' onClick={(e) => this.customAlert('Newfoundland', e)}>
            <path
              id='newfoundland'
          ...
          <Link xlinkTitle='canada' onClick={(e) => this.customAlert('Canada', e)}>
            <path
              id='canada'
          ...
          <Link xlinkTitle='United States' onClick={(e) => this.customAlert('United States', e)}>
            <path
              id='usa'
          ...
          <Link xlinkTitle='haida gwaii' onClick={(e) => this.customAlert('Haida Gwaii', e)}>
            <path
              id='haida gwaii'
          ...
          <Link xlinkTitle='vancouver' onClick={(e) => this.customAlert('Vancouver', e)}>
            <path
              id='vancouver'
              d='M139.45,147.95l-1.53,0.6l2.81,3.26l0.68,3.86l2.81,3l2.38-0.43v-3.94l-2.89-1.8L139.45,147.95L139.45,147.95z'
            />
          </Link>
          <Link xlinkTitle='guatemala' onClick={(e) => this.customAlert('Guatemala', e)}>
            <path
              id='guatemala'
          ...
          <Link xlinkTitle='costa rica' onClick={(e) => this.customAlert('Costa Rica', e)}>
            <path
              id='costa rica'
              d='M217.38,304.98l1.39,2.72l1.13,1.5l-1.52,4.51l-2.9-2.04l-4.74-4.34v-2.87L217.38,304.98L217.38,304.98z'
            />
          </Link>
          <Link xlinkTitle='Panama' onClick={(e) => this.customAlert('Panama', e)}>
            <path
              id='Panama'
          ...
          <Link xlinkTitle='colombia' onClick={(e) => this.customAlert('Colombia', e)}>
            <path
              id='colombia'
          ...
          <Link xlinkTitle='venezuela' onClick={(e) => this.customAlert('Venezuela', e)}>
            <path
              id='venezuela'
          ...
          <Link xlinkTitle='guyana' onClick={(e) => this.customAlert('Guyana', e)}>
            <path
              id='guyana'
          ...
          <Link xlinkTitle='suriname' onClick={(e) => this.customAlert('Suriname', e)}>
            <path
              id='suriname'
          ...
          <Link xlinkTitle='chiloe' onClick={(e) => this.customAlert('Chiloe', e)}>
            <path
              id='chiloe'
              d='M262.28,475.14l-1.29,1.95l0.65,3.39l1.29,0.13l0.65-4.3L262.28,475.14L262.28,475.14z'
            />
          </Link>
          <Link xlinkTitle='brazil' onClick={(e) => this.customAlert('Brazil', e)}>
            <path
              id='brazil'
          ...
          <Link xlinkTitle='belize' onClick={(e) => this.customAlert('Belize', e)}>
            <path
              id='belize'
              d='M204.56,282.4l-0.05,3.65h0.84l2.86-5.34h-1.94L204.56,282.4L204.56,282.4z'
            />
          </Link>
          <Link xlinkTitle='russia' onClick={(e) => this.customAlert('Russia', e)}>
            <path
              id='russia'
          ...
          <Link xlinkTitle='china' onClick={(e) => this.customAlert('China', e)}>
            <path
              id='china'
          ...
          <Link xlinkTitle='mongolia' onClick={(e) => this.customAlert('Mongolia', e)}>
            <path
              id='mongolia'
              d='M673.8,170.17l5.82-7.72l6.99,3.23l4.75,1.27l5.82-5.34l-3.95-2.91l2.6-3.67l7.76,2.74l2.69,4.41l4.86,0.13l2.54-1.89l5.23-0.21l1.14,1.94l8.69,0.44l5.5-5.61l7.61,0.8l-0.44,7.64l3.33,0.76l4.09-1.86l4.33,2.14l-0.1,1.08l-3.14,0.09l-3.27,6.86l-2.54,0.25l-9.88,12.91l-10.09,4.45l-6.31,0.49l-5.24-3.38l-6.7,3.58l-6.6-2.05l-1.87-4.79l-12.5-0.88l-6.4-10.85l-3.11-0.2L673.8,170.17L673.8,170.17z'
            />
          </Link>
          <Link xlinkTitle='north korea' onClick={(e) => this.customAlert('North Korea', e)}>
            <path
              id='north korea'
          ...
          <Link xlinkTitle='south korea' onClick={(e) => this.customAlert('South Korea', e)}>
            <path
              id='south korea'
          ...
          <Link xlinkTitle='Kazakhstan' onClick={(e) => this.customAlert('Kazakhstan', e)}>
            <path
              id='Kazakhstan'
          ...
          <Link xlinkTitle='turkmenistan' onClick={(e) => this.customAlert('Turkmenistan', e)}>
            <path
              id='turkmenistan'
          ...
          <Link xlinkTitle='uzbekistan' onClick={(e) => this.customAlert('Uzbekistan', e)}>
            <path
              id='uzbekistan'
          ...
          <Link xlinkTitle='tajikistan' onClick={(e) => this.customAlert('Tajikistan', e)}>
            <path
              id='tajikistan'
          ...
          <Link xlinkTitle='Kirgizstan' onClick={(e) => this.customAlert('Kirgizstan', e)}>
            <path
              id='Kirgizstan'
          ...
          <Link xlinkTitle='Afghanistan' onClick={(e) => this.customAlert('Afghanistan', e)}>
            <path
              id='Afghanistan'
          ...
          <Link xlinkTitle='Pakistan' onClick={(e) => this.customAlert('Pakistan', e)}>
            <path
              id='Pakistan'
          ...
          <Link xlinkTitle='India' onClick={(e) => this.customAlert('India', e)}>
            <path
              id='India'
          ...
          <Link xlinkTitle='burma' onClick={(e) => this.customAlert('Burma', e)}>
            <path
              id='burma'
              d='M729.44,303.65l-2.77-4.44l2.01-2.82l-1.9-3.49l-1.79-0.34l-0.34-5.86l-2.68-5.19l-0.78,1.24l-1.79,3.04l-2.24,0.34l-1.12-1.47l-0.56-3.95l-1.68-3.16l-6.84-6.45l1.68-1.11l0.31-4.67l2.5-4.2l1.08-10.45l3.62-2.47l0.12-3.81l2.17,0.72l3.42,4.95l-2.54,5.44l1.71,4.27l4.23,1.66l0.77,4.65l5.68,0.88l-1.57,2.71l-7.16,2.82l-0.78,4.62l5.26,6.76l0.22,3.61l-1.23,1.24l0.11,1.13l3.92,5.75l0.11,5.97L729.44,303.65L729.44,303.65z'
            />
          </Link>
          <Link xlinkTitle='thailand' onClick={(e) => this.customAlert('Thailand', e)}>
            <path
              id='thailand'
          ...
          <Link xlinkTitle='malaysia' onClick={(e) => this.customAlert('Malaysia', e)}>
            <path
              id='malaysia'
          ...
          <Link xlinkTitle='cambodia' onClick={(e) => this.customAlert('Cambodia', e)}>
            <path
              id='cambodia'
          ...
          <Link xlinkTitle='laos' onClick={(e) => this.customAlert('Laos', e)}>
            <path
              id='laos'
          ...
          <Link xlinkTitle='vietnam' onClick={(e) => this.customAlert('Vietnam', e)}>
            <path
              id='vietnam'
          ...
          <Link xlinkTitle='iran' onClick={(e) => this.customAlert('Iran', e)}>
            <path
              id='iran'
          ...
          <Link xlinkTitle='turkey' onClick={(e) => this.customAlert('Turkey', e)}>
            <path
              id='turkey'
          ...
          <Link xlinkTitle='yemen' onClick={(e) => this.customAlert('Yemen', e)}>
            <path
              id='yemen'
          ...
          <Link xlinkTitle='oman' onClick={(e) => this.customAleOt('Oman', e)}>
            <path
              id='oman'
          ...
          <Link xlinkTitle='syria' onClick={(e) => this.customAlert('Syria', e)}>
            <path
              id='syria'
          ...
          <Link xlinkTitle='iraq' onClick={(e) => this.customAlert('Iraq', e)}>
            <path
              id='iraq'
          ...
          <Link xlinkTitle='jordan' onClick={(e) => this.customAlert('Jordan', e)}>
            <path
              id='jordan'
          ...
          <Link xlinkTitle='britain' onClick={(e) => this.customAlert('Britain', e)}>
            <path
              id='britain'
          ...
          <Link xlinkTitle='ulster' onClick={(e) => this.customAlert('Ulster', e)}>
            <path
              id='ulster'
              d='M438.42,161.47l-3.3,0.37l-0.18,2.96l2.2,1.48l2.38-0.55l0.92-1.66L438.42,161.47L438.42,161.47z'
            />
          </Link>
          <Link xlinkTitle='ireland' onClick={(e) => this.customAlert('Ireland', e)}>
            <path
              id='ireland'
          ...
          <Link xlinkTitle='sweden' onClick={(e) => this.customAlert('Sweden', e)}>
            <path
              id='sweden'
          ...
          <Link xlinkTitle='finland' onClick={(e) => this.customAlert('Finland', e)}>
            <path
              id='finland'
          ...
          <Link xlinkTitle='belarus' onClick={(e) => this.customAlert('Belarus', e)}>
            <path
              id='belarus'
          ...
          <Link xlinkTitle='Poland' onClick={(e) => this.customAlert('Poland', e)}>
            <path
              id='Poland'
          ...
          <Link xlinkTitle='spain' onClick={(e) => this.customAlert('Spain', e)}>
            <path
              id='spain'
          ...
          <Link xlinkTitle='Portugal' onClick={(e) => this.customAlert('Portugal', e)}>
            <path
              id='Portugal'
          ...
          <Link xlinkTitle='netherlands' onClick={(e) => this.customAlert('Netherlands', e)}>
            <path
              id='netherlands'
          ...
          <Link xlinkTitle='belgium' onClick={(e) => this.customAlert('Belgium', e)}>
            <path
              id='belgium'
              d='M461.61,176.52l-0.64,1.6l6.88,4.54l1.98,0.47l0.07-2.15l-1.73-1.94h-1.06l-1.45-1.65L461.61,176.52L461.61,176.52z'
            />
          </Link>
          <Link xlinkTitle='germany' onClick={(e) => this.customAlert('Germany', e)}>
            <path
              id='germany'
          ...
          <Link xlinkTitle='denmark' onClick={(e) => this.customAlert('Denmark', e)}>
            <path
              id='denmark'
          ...
          <Link xlinkTitle='sjælland' onClick={(e) => this.customAlert('Sjælland', e)}>
            <path
              id='sjælland'
              d='M481.44,159.64l-0.93-0.04l-1.22,1.12l0.15,1.75l2.89,0.08l0.15-1.98L481.44,159.64L481.44,159.64z'
            />
          </Link>
          <Link xlinkTitle='gotland' onClick={(e) => this.customAlert('Gotland', e)}>
            <path
              id='gotland'
              d='M498.49,150.17l-2.11,1.67l1.06,2.45l1.87-1.82L498.49,150.17L498.49,150.17z'
            />
          </Link>
          <Link xlinkTitle='switzerland' onClick={(e) => this.customAlert('Switzerland', e)}>
            <path
              id='switzerland'
          ...
          <Link xlinkTitle='Austria' onClick={(e) => this.customAlert('Austria', e)}>
            <path
              id='Austria'
          ...
          <Link xlinkTitle='hungary' onClick={(e) => this.customAlert('Hungary', e)}>
            <path
              id='hungary'
          ...
          <Link xlinkTitle='slovenia' onClick={(e) => this.customAlert('Slovenia', e)}>
            <path
              id='slovenia'
              d='M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z'
            />
          </Link>
          <Link xlinkTitle='croatia' onClick={(e) => this.customAlert('Croatia', e)}>
            <path
              id='croatia'
          ...
          <Link xlinkTitle='bosnia' onClick={(e) => this.customAlert('Bosnia', e)}>
            <path
              id='bosnia'
              d='M494.8,198.94l-0.37,0.61l6.71,6.92l2.46-3.62l-0.09-1.43l-2.15-2.61L494.8,198.94L494.8,198.94z'
            />
          </Link>
          <Link xlinkTitle='italy' onClick={(e) => this.customAlert('Italy', e)}>
            <path
              id='italy'
          ...
          <Link xlinkTitle='moldova' onClick={(e) => this.customAlert('Moldova', e)}>
            <path
              id='moldova'
              d='M520.75,187.71l3.1,4.77l-0.26,2.7l1.11,0.05l2.63-4.45l-3.16-3.92l-1.79-0.74L520.75,187.71L520.75,187.71z'
            />
          </Link>
          <Link xlinkTitle='romania' onClick={(e) => this.customAlert('Romania', e)}>
            <path
              id='romania'
          ...
          <Link xlinkTitle='montenegro' onClick={(e) => this.customAlert('Montenegro', e)}>
            <path
          ...
          <Link xlinkTitle='serbia' onClick={(e) => this.customAlert('Serbia', e)}>
            <path
          ...
          <Link xlinkTitle='bulgaria' onClick={(e) => this.customAlert('Bulgaria', e)}>
            <path
              id='bulgaria'
          ...
          <Link xlinkTitle='thrace' onClick={(e) => this.customAlert('Thrace', e)}>
            <path
              id='thrace'
              d='M523.02,209.7l-0.16,3.55l3.1-0.95l1.42-0.95l-0.42-1.54l-1.47-1.17L523.02,209.7L523.02,209.7z'
            />
          </Link>
          <Link xlinkTitle='crete' onClick={(e) => this.customAlert('Crete', e)}>
            <path
              id='crete'
